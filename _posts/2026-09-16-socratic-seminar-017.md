...
* [Boltz suspende operação após ataques assistidos por IA](https://xcancel.com/Boltzhq/status/2087636521746674168){:target="_blank"} - A Boltz, serviço não custodial de swaps sobre Lightning, suspendeu a operação em 03/08/2026 após meses sob ataques cada vez mais frequentes e sofisticados assistidos por IA — vários tiveram sucesso, mas fundos de usuários nunca ficaram em risco porque o serviço é não custodial —; os três fundadores saíram sem papel formal no projeto; um grupo não identificado de "veteranos" do Bitcoin assumiu o controle com o objetivo declarado de restabelecer o serviço o quanto antes; e em 10/08/2026 a [Blockstream lançou um serviço concorrente](https://blog.blockstream.com/announcing-blockstream-swaps/){:target="_blank"} ("Blockstream Swaps", em beta) para reforçar a resiliência do ecossistema.
